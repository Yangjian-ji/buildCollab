...
public class MyChatAdapter extends RecyclerView.Adapter<MyChatAdapter.viewHolder> {
    ...
    public MyChatAdapter(Context context, Activity activity, List<Groups> groups, OnItemClickListener listener) {
    ...
    public void onBindViewHolder(final MyChatAdapter.viewHolder holder, int position) {
